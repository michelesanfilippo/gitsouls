/** Brand marks, shared by the profile and duel share boxes. */
...
/** The three-node share glyph used on the primary share buttons. */
export function ShareGlyph({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={className}
